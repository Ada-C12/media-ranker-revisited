...
describe WorksController do
  ...
  describe "index" do
    it "succeeds when there are works for logged-in users" do
      user = users(:dan)
      perform_login(user)
    ...
    it "succeeds when there are no works for logged-in users" do
      user = users(:dan)
      perform_login(user)
  ...
  describe "show" do
    ...
    it "redirects to the root page for guests" do
      get work_path(existing_work.id)
  ...
  describe "upvote" do
    ...
    it "redirects to the work page if the user has already voted for that work" do
      ...
      assert(flash[:message] = "has already voted for this work")
      must_redirect_to work_path(work)
    end
  end
end
