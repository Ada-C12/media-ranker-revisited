...
describe WorksController do
  ...
  describe "logged in user" do 
    ...
    describe "upvote" do
      ...
      it "redirects to the work page after the user has logged out" do
        # I'm really not sure what this test is asking me to do- after a user logs out, they are no longer allowed to see a work show page.
      end
  ...
  describe "logged out user" do 
    describe "root" do 
      it "will show the root page for a guest user" do 
        get root_path
        must_respond_with :success
      end 
    end 
    ...
    describe "index" do 
      it "does not show index works page for a guest user, responds with redirect and error" do 
        get works_path
        must_redirect_to root_path 
    ...
    describe "new" do 
      it "does not show the new works page, responds with redirect and error" do 
        get new_work_path
        must_redirect_to root_path 
        assert_equal "You must be logged in to access this feature.", flash[:error]
      end 
    ...
    describe "create" do
      it "will not create a work if a user is not logged in" do 
        new_work = { work: { title: "Dirty Computer", category: "album" } }
    ...
    describe "show" do 
      it "wont show a work page and display an error message" do 
        get work_path(existing_work.id)
    ...
    describe "upvote" do 
      it "will not upvote, and redirects to the work page if no user is logged in" do
        post upvote_path(existing_work.id)
