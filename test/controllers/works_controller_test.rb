...
describe WorksController do
  ...
  describe "Logged in users" do
      ...
      let(:login) {perform_login(users(:khabib))}
  ...
  describe "Guest users" do
    it "can access the root/homepage" do
      get root_path
      must_respond_with :success
      expect(flash[:result_text].must_equal nil)
    end 
    ...
    it "can't access the show page for any work" do
      get work_path(existing_work.id)
