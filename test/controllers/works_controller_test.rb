...
describe WorksController do
  ...
  describe "create" do
    it "does not allow a guest user to create a work" do
      new_work = { work: { title: "Dirtier Computer", category: "album" }}
  ...
  describe "update" do
    it "does not allow a guest user to update a work" do
      updates = { work: { title: "Dirtier Computer" } }
      existing_title = existing_work.title
      
      expect{ put work_path(existing_work.id) }.wont_change "Work.count"
      
      existing_work.title.must_equal existing_title
      must_respond_with :redirect
      must_redirect_to root_path
    end
    ...
    describe "logged-in user" do
      ...
      it "does not allow a logged-in user to update a work that does not belong to them" do
        ...
        not_your_work.title.must_equal existing_title
        must_respond_with :redirect
      end
    end
  end
  ...
  describe "destroy" do
    it "does not allow a guest user to destroy a work" do 
      expect { 
